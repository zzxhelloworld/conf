...
public class JSONParser {
	...
	public void parseJSON(String jsonFileAdd) throws IOException {
        ...
        for(int j = 0;j < fds.size();j ++) {
        	...
        	if(attr_set_left.length == 1 && "".equals(attr_set_left[0])) {
        		for(String r : attr_set_right) {//将right hand side中的元素组变为当个元素，left hand side不变,一个fd可以变成多个atomic fd
    ...
    public static void main(String[] args) throws IOException {
        ...
        json.parseJSON("C:\\Users\\wang\\Desktop\\phd论文\\项目2-com-object-NF\\FD Results\\Complete Data\\adult.json");
