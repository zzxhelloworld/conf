...
>> Once you get the 14 datasets, you can leverage some tools to produce atomic FDs and then use if needed. While for TPC-H benchmark, we have set FDs in codes.
>4. JDK & JDBC
